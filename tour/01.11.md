...
* 上一节：[1.10 短声明变量（Short variable declarations）](https://github.com/alphaeye/go-zh/blob/master/tour/01.10.md)
* 下一节：[1.12 零值（Zero values）](https://github.com/alphaeye/go-zh/blob/master/tour/01.12.md)
