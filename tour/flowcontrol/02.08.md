...
* 上一节：[2.07 if 和 else（If and else）](https://github.com/gnefiy/go-zh/blob/master/tour/flowcontrol/02.07.md)
* 下一节：[2.09 switch](https://github.com/gnefiy/go-zh/blob/master/tour/flowcontrol/02.09.md)
